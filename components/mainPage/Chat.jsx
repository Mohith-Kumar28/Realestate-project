...
<div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen bg-white rounded-lg">
   <div className="flex sm:items-center justify-between py-3 px-3 border-b-2 border-gray-200 ">
      <div className="relative flex items-center space-x-4">
         ...
         <div className="flex flex-col leading-tight">
            <div className="text-2xl mt-1 flex items-center">
               <span className="text-gray-700 mr-3">John Smith</span>
            </div>
            <span className="text-lg text-gray-600">Customer Support</span>
         </div>
      </div>
      <div className="flex items-center space-x-2">
         ...
         <button type="button" className="hidden sm:inline-flex items-center justify-center rounded-lg border h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6">
  ...
  <ScrollChat/>  <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      <div className="relative flex">
         ...
         <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
            <button type="button" className="hidden xl:inline-flex  items-center justify-center rounded-full h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6 text-gray-600">
