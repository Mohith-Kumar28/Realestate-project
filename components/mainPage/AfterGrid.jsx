  ...
  <div className="container px-5 pb-24 mx-auto flex flex-wrap">
    ...
    <div className="flex relative pt-5 pb-20 sm:items-center md:w-2/3 mx-auto">
      <div className="h-full w-6 absolute inset-0 flex items-center justify-center">
        <div className="h-[70%] md:h-3/5 mt-auto w-1 bg-gray-800 pointer-events-none"></div>
      </div>
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="flex-shrink-0 w-24 h-24 bg-gray-800 text-yellow-400 rounded-full inline-flex items-center justify-center">
...
<section className="text-gray-100 relative pt-5   body-font">
  ...
  <div className="container relative z-20 max-w-4xl mx-auto flex px-10 pt-28 md:flex-row-reverse  w-full  flex-col items-center">
    ...
    <div className="lg:max-w-lg  md:w-2/5 w-5/6 md:mb-0">
