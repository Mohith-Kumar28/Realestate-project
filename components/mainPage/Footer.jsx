const Footer = () => {
  ...
  <div className="container bg-yellow-200 rounded-3xl max-w-2xl px-14 py-12 mx-auto flex items-center md:flex-row flex-col">
    ...
    <button className="shadow-inner inline-flex font-bold text-gray-600 rounded-xl  bg-white border-4 border-yellow-400 py-2 px-6  focus:outline-none hover:bg-yellow-600  hover:text-white text-lg">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 mr-2 mt-1">
...
<footer className="text-gray-400 bg-gray-700 body-font">
  <div className="container px-5 lg:px-16 py-24 mx-auto flex md:items-center  md:flex-row md:flex-nowrap flex-wrap flex-col">
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2020 company name —
