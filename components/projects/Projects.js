...
const Projects = () => {
  ...
  <div className=" flex px-20 pb-24 md:flex-row flex-col items-center">
    <div className="border-4 border-gray-600 relative rounded-2xl lg:max-w-sm lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
...
<section class="text-gray-400 bg-gray-900 body-font">
  <div class="container mx-auto flex px-20 py-24 md:flex-row flex-col items-center">
    ...
    <div class="border-4 border-gray-600 relative rounded-2xl lg:max-w-sm lg:w-full md:w-1/2 w-5/6">
